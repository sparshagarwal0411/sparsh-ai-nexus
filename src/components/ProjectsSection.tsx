...
const projects = [
  {
    ...
    bgImage: "/WomenPreneur.png",
  },
  {
    title: "Cyber Hub",
    desc: "CyberHub — Your digital shield against cyber threats.",
    tech: ["React", "Node JS", "Supabase", "Gemini API", "Global API"],
    live: "https://cyber-hub-liart.vercel.app/",
    github: "https://github.com/sparshagarwal0411/cyber-hub",
    accent: "primary",
    image: "/llock.png",
    bgImage: "/llock.png",
  },
  {
    ...
    live: "https://green-canopy-connect.vercel.app/",
    github: "https://github.com/sparshagarwal0411/green-canopy-connect",
    accent: "primary",
    image: "/ggc.png",
    bgImage: "/lggc.jpg",
  },
